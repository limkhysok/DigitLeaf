...
def create_user_token(session: Session, user_name: str, refresh_token: str, expires_at: datetime) -> UserToken:
    db_token = UserToken(user_name=user_name, refresh_token=refresh_token, expires_at=expires_at)
