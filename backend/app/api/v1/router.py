...
from app.domains.farmer_contract import api as farmer_contract
...
api_router.include_router(farmer_contract.router, prefix="/farmer-contract", tags=["farmer-contract"])
